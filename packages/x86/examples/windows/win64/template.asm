...
; Template for program using standard Win64 headers
...
section '.data' data readable writeable
  ...
  wc WNDCLASSEX cbSize:sizeof WNDCLASSEX, style:0, lpfnWndProc:WindowProc, hbrBackground:COLOR_BTNFACE+1, lpszClassName:_class
